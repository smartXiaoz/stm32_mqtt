...
#define  PRODUCTKEY           "a1XepFPgFqx"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "test01"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "198088330158e5734cc69760f864d89a"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1XepFPgFqx/test01/thing/service/property/set"   //需要订阅的主题                                
                                
#define  P_TOPIC_NAME         "/sys/a1XepFPgFqx/test01/thing/event/property/post"    //需要发布的主题         
